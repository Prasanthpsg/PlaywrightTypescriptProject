...
export default defineConfig({
 ...
 // workers: process.env.CI ? 1 : undefined,
  ...
  use: {
    ...
    storageState: 'auth.json' //Load login state for all tests
  },
  ...
  projects: [
    ...
    //   use: {
    //     headless: false,
    //     storageState: undefined   // Important: no auth.json before login
    //   }
    // },
    // {
    //   name: 'chromium',
    //   dependencies :["setup"],
    //   testMatch: 'tests\SauceCheckout_Fixture.spec.ts',
